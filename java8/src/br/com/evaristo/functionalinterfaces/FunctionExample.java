...
public class FunctionExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("Result addThen is : "+ function.andThen(addSomething).apply("java8"));

		System.out.println("Result Compose is : "+ function.compose(addSomething).apply("java8"));
